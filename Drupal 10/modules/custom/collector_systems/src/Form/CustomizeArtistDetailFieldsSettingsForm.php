...
class CustomizeArtistDetailFieldsSettingsForm extends ConfigFormBase {

  public function getFormId() {
    return 'customize_artist_detail_fields_settings_form';
  }

  protected function getEditableConfigNames() {
    return ['customize_artist_detail_fields.settings'];
  }

  public function buildForm(array $form, FormStateInterface $form_state) {

    // Load the current configuration settings.
      $config = \Drupal::config('customize_artist_detail_fields.settings');
  ...
  public function get_select_field1_options(){
    ...
    //get all the options
    $ArtistFieldsService = \Drupal::service('collector_systems.artist_fields_service');
    $ArtistFields = $ArtistFieldsService->getArtistFields();
  ...
  public function get_select_field2_options(){
    ...
    $tblnm = "collector_systems_artists_selected_fields";
    $settblnm = $tblnm;
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
      ...
      $table_name = 'collector_systems_artists_selected_fields';
